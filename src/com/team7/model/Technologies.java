...
public class Technologies {
    ...
    public Technologies(){
        ...
        technologies.add(new Technology("unit", "Explorer", "VisibilityRadius", 1, 5));  //only one hex available
        technologies.add(new Technology("unit" ,"Explorer",  "AttackStrength", 0, 5));
